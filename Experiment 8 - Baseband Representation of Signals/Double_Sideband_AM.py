...
class Double_Sideband_AM(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "Double_Sideband_AM")
        ...
        self.qtgui_time_sink_x_0_1_0 = qtgui.time_sink_f(
            1024, #size
            10000, #samp_rate
            'Carrier Signal (Cosine) in Time Domain', #name
            1, #number of inputs
            None # parent
        )
        ...
        self.qtgui_time_sink_x_0_1_0.set_y_label('Amplitude', 'Volts')
        ...
        self.qtgui_time_sink_x_0_1 = qtgui.time_sink_f(
            1024, #size
            samp_rate, #samp_rate
            'Mesage Signal (Sine) in Time Domain', #name
            1, #number of inputs
            None # parent
        )
        ...
        self.qtgui_time_sink_x_0_1.set_y_label('Amplitude', 'Volts')
        ...
        self.qtgui_time_sink_x_0_0 = qtgui.time_sink_f(
            1024, #size
            samp_rate, #samp_rate
            'Modulated Signal u(t) in Time Domain', #name
            1, #number of inputs
            None # parent
        )
        ...
        self.qtgui_time_sink_x_0_0.set_y_label('Amplitude', 'Volts')
        ...
        self.qtgui_time_sink_x_0 = qtgui.time_sink_f(
            1024, #size
            samp_rate, #samp_rate
            'Demodulated Signal in Time Domain', #name
            1, #number of inputs
            None # parent
        )
        ...
        self.qtgui_time_sink_x_0.set_y_label('Amplitude', 'Volts')
        ...
        self.qtgui_freq_sink_x_0_1_0 = qtgui.freq_sink_f(
            ...
            0, #fc
            samp_rate, #bw
            'Carrier Signal (Cosine) in Frequency Domain', #name
            1,
            None # parent
        )
        ...
        self.qtgui_freq_sink_x_0_1 = qtgui.freq_sink_f(
            ...
            0, #fc
            samp_rate, #bw
            'Mesage Signal (Sine) in Frequency Domain', #name
            1,
            None # parent
        )
        ...
        self.qtgui_freq_sink_x_0_0 = qtgui.freq_sink_f(
            ...
            0, #fc
            samp_rate, #bw
            'Modulated Signal u(t) in Frequency Domain', #name
            1,
            None # parent
        )
        ...
        self.qtgui_freq_sink_x_0 = qtgui.freq_sink_f(
            ...
            0, #fc
            samp_rate, #bw
            'Demodulated Signal in Frequency Domain', #name
            1,
            None # parent
        )
        ...
        self.connect((self.blocks_throttle_0_0, 0), (self.qtgui_freq_sink_x_0_1_0, 0))
        self.connect((self.blocks_throttle_0_0, 0), (self.qtgui_time_sink_x_0_1_0, 0))
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.low_pass_filter_0.set_taps(firdes.low_pass(1, self.samp_rate, 1500, 500, window.WIN_RECTANGULAR, 6.76))
...
def main(top_block_cls=Double_Sideband_AM, options=None):
